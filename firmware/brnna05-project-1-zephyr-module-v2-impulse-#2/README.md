...
Model package name: brnna05-project-1
Model version: 2
Edge Impulse SDK version: v1.92.18
...
Check if the revision of the `edge-impulse-sdk-zephyr` module in your manifest file matches with the one needed for this model which is v1.92.18.
